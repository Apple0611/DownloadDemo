...
- (CGPoint)underStatusBarPoint:(CGPoint)point {
	...
	switch ([UIApplication sharedApplication].statusBarOrientation) {
		...
		{
			if (point.y == self.window.frameHeight - kAssistiveTouchWidth / 2) {
				point.y -= 20;
			}
		}
            break;
		...
		{
			if (point.x == self.window.frameWidth - kAssistiveTouchWidth / 2) {
				point.x -= 20;
			}
		}
            break;
	...
	if (UIInterfaceOrientationIsPortrait([UIApplication sharedApplication].statusBarOrientation)) {
		...
		else if (point.x == self.window.frameWidth - kAssistiveTouchWidth / 2 - 20) {
			point.x = self.window.frameWidth - kAssistiveTouchWidth / 2;
		}
	}
	else {
		...
		else if (point.y == self.window.frameHeight - kAssistiveTouchWidth / 2 - 20) {
			point.y = self.window.frameHeight - kAssistiveTouchWidth / 2;
		}
	}
